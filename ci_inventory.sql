...
(7, 'cri-hs0007', 'plantronics', 'HW121-N', 'DD8185', 'usb', 'NEW', 'SPARE', 'intern.jimre', NULL, '0000-00-00', NULL, 6, NULL, 'OLD OPS', 'Spare / Temporary'),
...
(20, 'cri-hs0020', 'plantronics', 'HW121-N', 'DJ5927', 'usb', 'NEW', 'SPARE', 'Capin, Craig', 'O''connor, Craig', '0000-00-00', '0000-00-00', 6, 7, 'OLD OPS', 'Temprarily Released by Rene to Maxie(02-13-2017)'),
...
(36, 'cri-hs0036', 'plantronics', 'HW121-N', 'DD8578', 'usb', 'NEW', 'DEPLOYED', 'Cabatingan, Erika', NULL, NULL, NULL, 6, 11, 'EXPANSION', 'no issued headset / temporary'),
...
(38, 'cri-hs0038', 'plantronics', 'HW121-N', 'DV3643 K9', 'usb', 'NEW', 'SPARE', 'Jimre Manigos', NULL, '0000-00-00', '0000-00-00', 6, NULL, NULL, 'already returned by Bryan for it is not usable to him anymore/Ok/Spare'),
(39, 'cri-hs0039', 'plantronics', 'HW121-N', 'DV3642', 'usb', 'NEW', NULL, 'Empleo, Genevieve ', 'Adams, Kaye', '0000-00-00', NULL, 3, 7, 'OLD OPS', NULL),
(40, 'cri-hs0040', 'plantronics', 'HW121-N', 'HM8276', 'usb', 'NEW', 'DEPLOYED', 'Flores, Charisse', 'Flores, Cris', '0000-00-00', NULL, NULL, 7, 'OLD OPS', 'issued headset is missing / temporary'),
...
(43, 'cri-hs0043', 'plantronics', 'HW121-N', 'DV3903', 'usb', 'NEW', 'DEPLOYED', 'Capistrano, Joan', 'Paige, Joan', '0000-00-00', NULL, 3, 7, 'OLD OPS', 'Ok/Spare/release by Eric'),
...
(46, 'cri-hs0046', 'plantronics', 'HW121-N', 'DD9170', 'usb', 'NEW', 'DEPLOYED', 'Pareja, April', NULL, NULL, NULL, 6, 4, 'OLD OPS', 'no issued headset / temporary'),
...
(51, 'cri-hs0051', 'plantronics', 'HW121-N', 'DD9439', 'usb', 'NEW', 'DEPLOYED', 'Tolentino, Cherrie', 'Rosen, Cherry', '0000-00-00', NULL, NULL, 7, 'OLD OPS', 'temporay'),
...
(54, 'cri-hs0054', 'plantronics', 'HW121-N', 'AV9404', 'usb', 'NEW', 'DEPLOYED', 'Caingcoy, Hazel Louise', 'Cain, Louisa', '0000-00-00', NULL, 3, NULL, 'EXPANSION', 'no issued headset / temporary'),
...
(56, 'cri-hs0056', 'plantronics', 'HW121-N', 'Bh9847', 'usb', 'NEW', '', 'Omila, Chianne', NULL, '0000-00-00', NULL, 6, NULL, 'OLD OPS', 'returned by Mikhaila Imbog'),
...
(63, 'HS0063', 'plantronics', 'HW121N', 'DJ6141', 'usb', 'NEW', NULL, 'Madeja, Maria Loradel', NULL, '0000-00-00', NULL, 6, NULL, NULL, NULL),
...
(67, 'HS0067', 'plantronics', 'HW121N', 'AU1838', 'usb', 'NEW', NULL, 'Lorica, Jason A.', 'Jason Johnston', '0000-00-00', NULL, 6, 7, 'OLD OPS', NULL),
...
(69, 'HS0069', 'plantronics', 'HW121N', 'DJ3932', 'usb', 'NEW', NULL, 'Miñoza, Namfrel', NULL, '0000-00-00', NULL, 6, 4, 'OLD OPS', NULL),
(70, 'HS0070', 'plantronics', 'HW121-N', 'BZ7097', 'usb', 'NEW', 'DEPLOYED', 'Pescador, Zoren', NULL, '0000-00-00', NULL, 6, 12, 'OLD OPS', NULL),
(71, 'HS0071', 'plantronics', 'HW121-N', 'DJ5098 K9', 'usb', 'NEW', 'DEFECTIVE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Can''t detect usb'),
(72, 'HS0072', 'plantronics', 'HW121N', 'DJ2178', 'usb', 'NEW', NULL, 'Blanco, Kent Jan', 'Harper, Ken', '0000-00-00', NULL, 6, 7, 'OLD OPS', NULL),
(73, 'HS0073', 'plantronics', 'HW121N', 'BM4629', 'usb', 'NEW', NULL, 'Amoncio, Eunice M.', 'Mace, Gabrien', '0000-00-00', NULL, 6, 7, 'OLD OPS', NULL),
...
(76, 'HS0076', 'plantronics', 'HW121N', 'DV3434', 'usb', 'NEW', NULL, 'Rentuma, John Kristoffer', 'White, Christopher', '0000-00-00', NULL, 6, 7, 'OLD OPS', NULL),
(77, 'HS0077', 'plantronics', 'HW121N', 'DJ4050', 'usb', 'NEW', NULL, 'Balansag, Earl Sidney', 'Dewitt, Sidney', '0000-00-00', NULL, 6, 7, 'OLD OPS', NULL),
(78, 'HS0078', 'plantronics', 'HW121N', 'DJ6063', 'usb', 'NEW', 'DEFECTIVE', 'Maskariño, Neil', NULL, '0000-00-00', NULL, 6, NULL, NULL, 'Can''t detect usb'),
(79, 'HS0079', 'plantronics', 'HW121N', 'BO8390', 'usb', 'NEW', 'DEPLOYED', 'Tecson, Elizer', NULL, '0000-00-00', NULL, 6, 12, 'OLD OPS', NULL),
(80, 'HS0080', 'plantronics', 'HW121-N', 'DJ2293', 'usb', 'NEW', 'DEPLOYED', 'Canales, Aimee', 'Roberts, Chloe', NULL, NULL, NULL, 7, 'OLD OPS', 'TEMPORARY'),
(81, 'HS0081', 'plantronics', 'HW121N', 'BF0874', 'usb', 'NEW', 'DEPLOYED', 'Bustamante, Maria', NULL, '0000-00-00', NULL, NULL, NULL, NULL, NULL),
(82, 'HS0082', 'plantronics', 'HW121N', 'BI0159', 'usb', 'NEW', 'SPARE', NULL, NULL, '0000-00-00', NULL, 6, NULL, NULL, 'OK / spare'),
(83, 'HS0083', 'plantronics', 'HW121N', 'AW2318', 'usb', 'NEW', '', 'Tabar, Jonveth', 'Boston, Betty', '0000-00-00', NULL, NULL, 10, 'EXPANSION', NULL),
(84, 'HS0084', 'plantronics', 'HW121N', 'AW2259', 'usb', 'NEW', NULL, 'Pocong, Jay-R', NULL, '0000-00-00', NULL, 6, 4, 'OLD OPS', NULL),
(85, 'HS0085', 'plantronics', 'HW121N', 'BH5541', 'usb', 'NEW', NULL, 'Balaro, Racel', 'David Tanner', '0000-00-00', NULL, 6, 7, 'OLD OPS', NULL),
(86, 'HS0086', 'plantronics', 'HW121N', 'DJ5095', 'usb', 'NEW', NULL, 'Artiaga, Ariel', NULL, '0000-00-00', NULL, 6, 4, 'OLD OPS', NULL),
...
(90, 'HS0090', 'plantronics', 'HW121N', 'DJ3403', 'usb', 'NEW', NULL, 'Cruz, Mary Erika', NULL, '0000-00-00', NULL, 6, 4, 'OLD OPS', NULL),
(91, 'HS0091', 'plantronics', 'HW121N', 'AV9399', 'usb', 'NEW', 'DEPLOYED', 'Diapana, Marilyn', NULL, NULL, '0000-00-00', 6, 12, 'OLD OPS', 'returned / received by Rene'),
(92, 'HS0092', 'plantronics', 'HW121N', 'DJ3624', 'usb', 'NEW', 'DEPLOYED', 'Maskariño, Neil', 'Mercer, Neil', '0000-00-00', NULL, NULL, 7, 'OLD OPS', 'Temporay'),
(93, 'HS0093', 'plantronics', 'HW121N', 'DJ5685', 'usb', 'NEW', NULL, 'Gonato, Marjon', NULL, '0000-00-00', NULL, 6, 4, 'OLD OPS', '`'),
...
(96, 'HS0096', 'plantronics', 'HW121N', 'BI0199', 'usb', 'NEW', 'DEPLOYED', 'Vega, Mary', 'Smith, Stephanie', '0000-00-00', NULL, NULL, 7, 'OLD OPS', 'Temporary'),
(97, 'HS0097', 'plantronics', 'HW121N', 'DJ3671', 'usb', 'NEW', NULL, 'Bani, Nancy', 'Andrews, Nancy', '0000-00-00', NULL, 6, 7, 'OLD OPS', NULL),
(98, 'HS0098', 'plantronics', 'HW121N', 'DJ3185', 'usb', 'NEW', NULL, 'Barliso, Lorell', 'Elle Simpson', NULL, NULL, NULL, 7, 'OLD OPS', NULL),
(99, 'HS0099', 'plantronics', 'HW121N', 'AW2059', 'usb', 'NEW', 'DEPLOYED', 'Pader, Herbert', 'Reid, Toni', '0000-00-00', NULL, NULL, 7, 'OLD OPS', 'Temporay'),
...
(103, 'HS0103', 'plantronics', 'HW121N', 'AV8723', 'usb', 'NEW', 'DEPLOYED', 'Apiag, Jommy', 'Davies, Tom', NULL, NULL, 6, 7, 'OLD OPS', 'temporary'),
(104, 'HS0104', 'plantronics', 'HW121N', 'BM4983', 'usb', 'NEW', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'can''t detect usb'),
(105, 'HS0105', 'plantronics', 'HW121N', 'BM7790', 'usb', 'NEW', 'DEPLOYED', 'Tabanas, Joseph Neil', 'Phelps, Leon', '0000-00-00', NULL, 4, 7, 'OLD OPS', 'Ok/Spare'),
(106, 'HS0106', 'plantronics', 'HW121N', 'GU4077', 'usb', 'NEW', NULL, 'Orlando Walag', 'Laine Wallace', '0000-00-00', NULL, 6, NULL, 'EXPANSION', NULL),
(107, 'HS0107', 'plantronics', 'HW121N', 'EB1434', 'usb', 'NEW', NULL, 'Tecson, Kressa', 'Avila Kate', '0000-00-00', NULL, 6, 7, 'OLD OPS', NULL),
(108, 'HS0108', 'plantronics', 'HW121N', 'BH9838 H9', 'usb', 'NEW', 'DEFECTIVE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(109, 'cri-old-hs001', 'plantronics', 'DA60', 'VU2220 I2', 'usb', 'OLD', NULL, 'Aringay. Mary ', NULL, '0000-00-00', NULL, 6, 12, 'OLD OPS', 'released by RENE'),
(110, 'cri-old-hs005', 'plantronics', 'DA60', NULL, 'usb', 'OLD', 'DEPLOYED', 'Alferez, Rutchell', NULL, '0000-00-00', NULL, 6, 12, 'OLD OPS', 'issued temporarily to Rutchell'),
(111, 'cri-old-hs010', 'A4tech', 'HS-5P', NULL, '3.5 jack', 'OLD', 'SPARE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Ok / Spare'),
(112, 'cri-old-hs011', 'A4tech', 'HS-5P', NULL, '3.5 jack', 'OLD', 'DEPLOYED', 'Granada.Arcelie', NULL, NULL, NULL, 6, NULL, NULL, 'Permanent'),
...
(116, NULL, NULL, NULL, NULL, 'usb', 'OLD', 'DEPLOYED', 'Prime Dionson', NULL, '0000-00-00', NULL, 6, NULL, 'EXPANSION', 'Permanently deployed old headset to Sir Prime / note: label is not visible anymore');
